...
<form action="http://localhost:8080/sincart/purchase" method="post">
...
if (hs.getAttribute("info")!=null)
{
	...
	<table border="1" align="center">
            <tr>   
            <td>Item </td><td> Price</td>  <td>Dsize</td> <td>Color</td> <td>Image</td>  
            </tr>
		<%  for(i=0;i<ar.size();i++)
	{
		ItemBeen fi=(ItemBeen)ar.get(i);%>
		 ...
		 <tr>
		  ...
		  <td><%=fi.getQuantity()%><input type="hidden" name="iq<%=i%>" value="<%=fi.getQuantity() %>" ></td>
